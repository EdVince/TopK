    ...
    ) 
{
    ...
    uint16_t* d_scores[2] = {nullptr,nullptr};
    ...
    cudaMalloc(&d_scores[0], sizeof(uint16_t) * N * 8); // 2*8000000*8=128MB
    cudaMalloc(&d_scores[1], sizeof(uint16_t) * N * 8); // 2*8000000*8=128MB
